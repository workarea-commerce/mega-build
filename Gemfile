...
gem 'workarea-product_bundles', github: 'workarea-commerce/workarea-product-bundles'
...
gem 'workarea-reviews', github: 'workarea-commerce/workarea-reviews', branch: 'v3.1-stable'
gem 'workarea-save_for_later', github: 'workarea-commerce/workarea-save-for-later'
gem 'workarea-share', github: 'workarea-commerce/workarea-share', branch: 'v1.3-stable'
